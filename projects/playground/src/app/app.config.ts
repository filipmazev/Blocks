...
import { NAVIGATION_CONFIG } from '@navigation/tokens/navigation-config.token';
...
import { NAVIGATION_I18N } from '@navigation/tokens/navigation-i18n.token';

export function provideNavigationI18n() {
  return {
    provide: NAVIGATION_I18N,
    useFactory: () => {
